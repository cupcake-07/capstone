...
// Helper: check token+email validity for teachers
    ...
    <style>
        ...
        * { box-sizing: border-box; }
        ...
        button {
            ...
            font-weight: 700;
            color: #fff;
            background: linear-gradient(90deg, #b83fa3ff, #4f65e0ff);
            cursor: pointer;
...
<div class="card">
    ...
    <?php if ($error_message): ?>
        ...
        <div class="back"><a href="teacher-login.php">← Back to Login</a></div>
    <?php else: ?>
